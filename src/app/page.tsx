        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 px-4 py-20 sm:px-6 lg:flex-row lg:items-center">
          ...
          <div className="relative flex-1">
            <div className="relative mx-auto max-w-xl overflow-hidden rounded-3xl border border-white/60 shadow-2xl">
              ...
              />
              {home.bannerTitle ? (
                <div className="absolute bottom-0 left-0 right-0 bg-white/70 p-4 text-gray-900 backdrop-blur">
                  {home.bannerTag ? (
                    <p className="text-xs font-semibold uppercase tracking-wide text-gray-600">{home.bannerTag}</p>
                  ) : null}
                <h2 className="text-lg font-semibold">{home.bannerTitle}</h2>
                </div>
              ) : null}
            </div>
          </div>
